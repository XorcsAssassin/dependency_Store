...
const app=express()
const logger=require('./logger_func_api5.js')
const authorize=require('./authorize_func_api8.js')
...
app.get('/about',(req,res)=>{   //to add these functionalities to particular routes
  console.log(req.user)   //will give undefined particularly for /about
